	...
	<div class="main"
		...
		<div class="container">
			...
			<div class="content">
				...
				<div class="subscribe">
					<h5 class="info-text">
						<s:message code="employee.login.check" />
					</h5>
					<div class="row">
							...
							<form:form class="form-inline" action="employee" method="post"
								...
								<div class="form-group">
									<%-- <a href="employee/forgot.htm" type="submit"
										class="btn btn-primary btn-fill "><s:message
											code="employee.forgot" />
									</a> --%>
									<button type="submit" class="btn btn-warning btn-fill">
										<s:message code="employee.login" />
									</button>
		...
		<div class="footer">
			<div class="container">
				...
				<!-- <a href="http://www.facebook.com/HieuBoyFC">Hiếu Boy</a>. -->
