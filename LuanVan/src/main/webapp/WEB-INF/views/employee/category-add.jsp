...
<title><s:message code="employee.category.add" /></title>
</head>
<style type="text/css">
*[id$=errors] {
	color: red;
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-block">
								<h4 class="card-title">
									<s:message code="employee.category.add" />
								</h4>
								<form:form action="employee/category/save-category.htm"
									method="POST" commandName="category">
									<div class="form-group">
										<label class="col-md-6"><s:message
												code="employee.category.name" />: (<span style="color: red;">*</span>)<form:errors
												path="nameCategory" /></label>
										<div class="col-md-6">
									...
									<div class="form-group">
										<label class="col-md-6"><s:message
												code="employee.category.nameEN" />: (<span style="color: red;">*</span>)<form:errors
												path="nameCategoryEN" /></label>
										<div class="col-md-6">
											<form:input path="nameCategoryEN" placeholder="Tên danh mục Tiếng Anh"
												size="30" maxlength="30"
												class="form-control form-control-line" />
										</div>
									</div>
