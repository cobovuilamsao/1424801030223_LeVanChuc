...
<title><s:message code="employee.producer.edit" /></title>
</head>
<style type="text/css">
*[id$=errors] {
	color: red;
					...
					<div class="col-md-5 col-8 align-self-center">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><s:message
									code="employee.producer.edit" /></li>
						</ol>
					</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-block">
								<h4 class="card-title">
									<s:message code="employee.producer.edit" />
								</h4>
								<form:form
									action="employee/producer/edit-producer/${producer.id }.htm"
