...
<body>
				...
				<ul class="nav navbar-nav">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"> <img src="login/images/flags/ZZ.png" />
							<s:message code="employee.login.language" /> <b class="caret"></b>
					</a>
	...
	<div class="main"
		...
		<div class="container">
			...
			<div class="content">
				<h4 class="motto">
					<s:message code="employee.login.title" />
				</h4>
				<div class="subscribe">
					<h5 class="info-text">
						<s:message code="employee.login.forgot" />
						<span style="color: red">${message}</span>
					</h5>
					<div class="row">
						<div class="col-md-4 col-md-offset-4 col-sm6-6 col-sm-offset-3 ">
							<form:form class="form-inline"
								action="employee/forgot.htm" modelAttribute="employee">
								<div class="form-group">
									<label class="sr-only" for="id">Username</label>
									<form:input path="id" placeholder="Please enter username employee"
		...
		<div class="footer">
			<div class="container">
				<s:message code="employee.login.made" />
				<i class="fa fa-heart heart"></i>
				<s:message code="employee.login.by" />
				<a href="http://www.fakebook.com/HieuBoyFC">Hiếu Boy</a>.
				<s:message code="employee.login.contact" />
				<a href="http://www.fakebook.com/HieuDTPH04388"><s:message
						code="employee.login.here" /></a>
			</div>
		</div>
	</div>
</body>
