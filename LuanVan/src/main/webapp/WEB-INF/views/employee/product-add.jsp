...
<title><s:message code="employee.product.add" /></title>
</head>
<style type="text/css">
*[id$=errors] {
	color: red;
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-block">
								<h4 class="card-title">
									<s:message code="employee.product.add" />
								</h4>
								<form:form action="employee/product/save-product.htm"
									method="POST" commandName="product"
									enctype="multipart/form-data">
									<div class="row">
										<div class="col-md-6">
											<label> <s:message
													code="employee.product.nameProduct" />: (<span
												style="color: red;">*</span>)<form:errors path="nameProduct" /></label>
